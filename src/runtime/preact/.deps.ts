...
export {
  type DenoConfig,
  loadDenoConfigSync,
} from "jsr:@fathym/common@0.2.167/build";
...
export {
  ...
  type ESBuildResult,
} from "jsr:@fathym/eac@0.2.9/esbuild";
...
export type {
  ...
  EverythingAsCodeDFS,
} from "jsr:@fathym/eac-dfs@0.0.8";
export type { DFSFileHandler } from "jsr:@fathym/eac-dfs@0.0.8/handlers";
export {
  executePathMatch,
